                ...
                <div class="p-6 text-gray-900">
                    ...
                    @if($appointments->isEmpty())
                        <div class="flex flex-col items-center justify-center py-12">
                            ...
                            <a href="{{ route('appointments.select-servicer', ['carId' => auth()->user()->cars->first()->id ?? 0]) }}" class="inline-flex items-center gap-2 px-5 py-2 bg-blue-600 text-white font-semibold rounded-lg shadow hover:bg-blue-700 transition">
                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
